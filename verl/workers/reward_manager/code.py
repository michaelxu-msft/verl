...
class CodeRewardManager(AbstractRewardManager):
    """The reward manager for code tasks."""
    ...
    def __call__(self, data: DataProto, return_dict=False):
        ...
        def process_item(args):
            ...
            return i, score, valid_response_length, extra_result_info, prompt_str, response_str, ground_truth, data_source, result
        ...
        # Fill reward tensor with results and apply overlong penalty
        for i, score, valid_response_length, extra_result_info, prompt_str, response_str, ground_truth, data_source, result in results:
